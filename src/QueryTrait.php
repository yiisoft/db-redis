 ...
 *
 * It is supposed to be used in a class that implements the {@see }.
 */
trait QueryTrait
{
    private $where;
     ...
     *
     * See {@see ::where()} for detailed documentation.
     *
     ...
     *
     * After this mode is enabled, methods, returning query results like {@see ::one()},
     * {@see ::all()}, {@see ::exists()} and so on, will return empty or false values.
    ...
    public function getEmulateExecution()
    {
